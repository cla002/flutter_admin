...
class NewDeliveryRider extends StatefulWidget {
  const NewDeliveryRider({Key? key});

  @override
  State<NewDeliveryRider> createState() => _NewDeliveryRiderState();
}

class _NewDeliveryRiderState extends State<NewDeliveryRider> {
      ...
      child: StreamBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.none) {
            ...
            return const Center(
              child: Text('No New Delivery Rider'),
            );
          }
        ...
        cells: [
          DataCell(
            Container(
              width: 50,
              height: 50,
              child: (document.data() as Map<String, dynamic>)['imageUrl'] == ''
                  ? const CircleAvatar(
